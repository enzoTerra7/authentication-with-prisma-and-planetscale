          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="#" className="text-xl font-bold flex items-center lg:ml-2.5">
                ...
                <span className="self-center whitespace-nowrap">Seja bem vindo, {session.user.name}</span>
              </a>
                  ...
                  <li>
                    <form action="#" method="GET" className="lg:hidden">
                      ...
                      <div className="relative">
                        ...
                        <input type="text" name="email" id="mobile-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-600
                          block w-full pl-10 p-2.5" placeholder="Search" />
                      </div>
                    </form>
                  </li>
                  <li>
              ...
              <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex items-center justify-end flex-1 textRed-500 text-base font-bold">
                      -2.7%
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                  ...
                  <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                      <thead>
                        <tr>
                          <th className="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 borderR-0 whitespace-nowrap">Top Channels</th>
                          <th className="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 borderR-0 whitespace-nowrap">Users</th>
                          <th className="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 borderR-0 whitespace-nowrap min-w-140-px"></th>
                        </tr>
                      </thead>
